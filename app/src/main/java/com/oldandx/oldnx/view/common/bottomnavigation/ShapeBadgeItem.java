...
@interface Shape {
    ...
    public ShapeBadgeItem setSizeInDp(Context context, int heightInDp, int widthInDp) {
        mHeightInPixels = BottomNavigationHelper.dp2px(context, heightInDp);
        mWidthInPixels = BottomNavigationHelper.dp2px(context, widthInDp);
    ...
    public ShapeBadgeItem setEdgeMarginInDp(Context context, int edgeMarginInDp) {
        mEdgeMarginInPx = BottomNavigationHelper.dp2px(context, edgeMarginInDp);
        refreshMargin();
        return this;
    }
    ...
    void bindToBottomTabInternal(BottomNavigationTab bottomNavigationTab) {
        if (mHeightInPixels == 0)
            mHeightInPixels = BottomNavigationHelper.dp2px(bottomNavigationTab.getContext(), 12);
        if (mWidthInPixels == 0)
            mWidthInPixels = BottomNavigationHelper.dp2px(bottomNavigationTab.getContext(), 12);
        if (mEdgeMarginInPx == 0)
            mEdgeMarginInPx = BottomNavigationHelper.dp2px(bottomNavigationTab.getContext(), 4);

        refreshMargin();
        refreshColor();// so that user set color will be updated

        bottomNavigationTab.mBadgeView.setShapeBadgeItem(this);

        bottomNavigationTab.mBadgeView.setDimens(mWidthInPixels, mHeightInPixels);
    }
