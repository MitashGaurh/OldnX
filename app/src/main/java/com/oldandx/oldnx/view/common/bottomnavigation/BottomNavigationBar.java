...
import com.oldandx.oldnx.databinding.BottomNavigationBarContainerBinding;
import com.oldandx.oldnx.utils.BottomNavigationHelper;
import com.oldandx.oldnx.view.common.bottomnavigation.behavior.BottomNavBarFabBehaviour;
...
public class BottomNavigationBar extends FrameLayout {
    ...
    private BottomNavigationBarContainerBinding mBottomNavigationBarContainerBinding;
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mActiveColor = typedArray.getColor(R.styleable.BottomNavigationBar_bnbActiveColor, BottomNavigationHelper.fetchContextColor(context, R.attr.colorAccent));
            ...
            mActiveColor = BottomNavigationHelper.fetchContextColor(context, R.attr.colorAccent);
    ...
    private void init() {
        ...
        mBottomNavigationBarContainerBinding
                = BottomNavigationBarContainerBinding.inflate(inflater, this, true);
    ...
    public void initialise() {
        ...
        if (!mBottomNavigationItems.isEmpty()) {
            mBottomNavigationBarContainerBinding.bottomNavigationBarItemContainer.removeAllViews();
            ...
            if (mBackgroundStyle == BACKGROUND_STYLE_STATIC) {
                mBottomNavigationBarContainerBinding.bottomNavigationBarOverLay.setVisibility(View.GONE);
                mBottomNavigationBarContainerBinding.bottomNavigationBarContainer.setBackgroundColor(mBackgroundColor);
            }

            int screenWidth = BottomNavigationHelper.getScreenWidth(getContext());
    ...
    public void clearAll() {
        ...
        mBottomNavigationBarContainerBinding.bottomNavigationBarOverLay.setVisibility(View.GONE);
        mBottomNavigationBarContainerBinding.bottomNavigationBarContainer.setBackgroundColor(Color.TRANSPARENT);
        mSelectedPosition = DEFAULT_SELECTED_POSITION;
    }
    ...
    private void setUpTab(boolean isNoTitleMode, BottomNavigationTab bottomNavigationTab, BottomNavigationItem currentItem, int itemWidth, int itemActiveWidth) {
        ...
        mBottomNavigationBarContainerBinding.bottomNavigationBarItemContainer.addView(bottomNavigationTab);
    }
        ...
        if (mSelectedPosition != newPosition) {
            if (mBackgroundStyle == BACKGROUND_STYLE_STATIC) {
                ...
                if (firstTab) {
                    ...
                    mBottomNavigationBarContainerBinding.bottomNavigationBarContainer.setBackgroundColor(clickedView.getActiveColor());
                    mBottomNavigationBarContainerBinding.bottomNavigationBarOverLay.setVisibility(View.GONE);
                } else {
                    mBottomNavigationBarContainerBinding.bottomNavigationBarOverLay.post(()
                            -> BottomNavigationHelper.setBackgroundWithRipple(clickedView
                            , mBottomNavigationBarContainerBinding.bottomNavigationBarContainer
                            , mBottomNavigationBarContainerBinding.bottomNavigationBarOverLay
