...
import com.oldandx.oldnx.databinding.ShiftingBottomNavigationItemBinding;
...
class ShiftingBottomNavigationTab extends BottomNavigationTab {
    ...
    void init() {
        ...
        ShiftingBottomNavigationItemBinding shiftingBottomNavigationItemBinding
                = ShiftingBottomNavigationItemBinding.inflate(inflater, this, true);
        ;
        mContainerView = shiftingBottomNavigationItemBinding.shiftingBottomNavigationContainer;
        mLabelView = shiftingBottomNavigationItemBinding.shiftingBottomNavigationTitle;
        mIconView = shiftingBottomNavigationItemBinding.shiftingBottomNavigationIcon;
        mIconContainerView = shiftingBottomNavigationItemBinding.shiftingBottomNavigationIconContainer;
        mBadgeView = shiftingBottomNavigationItemBinding.shiftingBottomNavigationBadge;
    ...
    public void select(boolean setActiveColor, int animationDuration) {
        ...
        mLabelView.animate().scaleY(1).scaleX(1).setDuration(animationDuration).start();
    }
    ...
    public void unSelect(boolean setActiveColor, int animationDuration) {
        ...
        mLabelView.animate().scaleY(0).scaleX(0).setDuration(0).start();
    }
