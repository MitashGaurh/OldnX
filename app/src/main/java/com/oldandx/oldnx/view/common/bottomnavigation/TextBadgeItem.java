...
public class TextBadgeItem extends BadgeItem<TextBadgeItem> {
    ...
    void bindToBottomTabInternal(BottomNavigationTab bottomNavigationTab) {
        ...
        bottomNavigationTab.mBadgeView.setBackgroundDrawable(shape);
        bottomNavigationTab.mBadgeView.setTextColor(getTextColor(context));
        bottomNavigationTab.mBadgeView.setText(getText());
    }
